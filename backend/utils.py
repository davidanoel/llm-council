"""Internal A2A authentication utilities."""
...
def generate_hmac_signature(secret):
    """Generate the signature expected by the internal token service."""
...
def get_a2a_jwt_token():
    """Request an A2A JWT for approved internal model routes."""
